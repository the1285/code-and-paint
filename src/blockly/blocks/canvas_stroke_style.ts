...
export function addBlocklyCanvasStrokeStyleBlock(): CanvasBlockDefinition {
  // ─── Setup ───────────────────────────────────────────────────────────

  const id = "stroke_style";
  ...
  const definition = {
    ...
    tooltip: "",
    helpUrl: "",
    message0: "استایل خط را تنظیم کن به رنگ %1",
    args0: [
      {
